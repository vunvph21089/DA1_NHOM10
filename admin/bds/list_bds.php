                                ...
                                <div class="row g-3">
                                    <div class="col-xl-6">
                                        <div class="search-box">
                                            <input type="text" name="keyword" class="form-control search" placeholder="Tìm kiếm theo tên">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-4">
                                                <div>
                                                    <select class="form-control" data-plugin="choices" data-choices data-choices-search-false name="id_loaibds" id="idStatus">
                                                        <option value="1">Căn hộ chung cư</option>
                                                        <option value="2">Nhà bán</option>
                                            ...
                                            <div class="col-sm-4">
                                                <div>
                                                    <input type="submit" name="search" class="btn btn-primary w-100" value="Lọc">
                                                </div>
                                            </div>
                                            <!--end col-->
                                        </div>
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                                ...
                                                foreach ($listbds as $bds) {
                                                    ...
                                                    $deletebds = "index.php?act=deletebds&id=" . $id;
                                                    $imgpath = "../uploads/" . $img;
                                                    if (is_file($imgpath)) {
                                                            ...
                                                            <td>
                                                                <ul class="list-inline hstack gap-2 mb-0">
                                                                 ...
                                                                 <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Remove">
                                                                     <a href="'.$deletebds.'" class="text-danger">
